...
export function KenoGame() {
  ...
  if (!isConnected) {
    return <div className="glass-card p-8"><p className="text-center text-sm">🚀 Open in Farcaster</p></div>;
  }
  ...
  if (!gameActive) {
    return (
      <div className="glass-card p-8 space-y-4">
        ...
        <input type="number" value={depositAmount} onChange={(e) => setDepositAmount(e.target.value)} className="w-full px-4 py-3 bg-black/40 border border-purple-500/30 rounded-lg text-white" />
  ...
  return (
    <div className="glass-card p-8 space-y-6">
      <div className="flex justify-between"><h2 className="text-2xl font-bold">🎰 KENO</h2><p className="text-xl font-bold">{gameBalance} ⚡</p></div>
      <div>
        <p className="text-sm opacity-70 mb-3">Select 1-10 numbers (1-80)</p>
